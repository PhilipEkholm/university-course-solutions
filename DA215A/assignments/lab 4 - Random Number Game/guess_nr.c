 ...
 *
 * - Added funcitonality for getting number
 * - Added functionality while playing the game
 *
 * Author:	Mathias Beckius, Philip Ekholm, Aron Polner
 *
 * Date:	2014-11-28
 */
