...
//vart justerar man antalet bitar i ADC?
// fast PWM, 8-bitar 21/27
void regulator_init(void)
{
	...
	ADMUX |= 0b00010000;		// select diff.amp 1x on ADC1
...
/*
* Returns a value between 0-100 depending on set duty cycle of potentiometer
*
*/
