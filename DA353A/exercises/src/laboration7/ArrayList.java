...
//Vi har kommit en lång väg som högskola, och vi kommer komma ännu längre som ett universitet. Jag kandiderar för att vi förtjänar en ledare som leder kåren till en ny och spännande tid för vår skola!
//We've come a long way as a högskola, and we will go even further as a university. I candidate because we deserve a leader who will lead the student union to a new and exciting time for our school!
...
//		};
	...
	/**
	 *	A main is placed here for internal testing, can be ignored. 
	 */
