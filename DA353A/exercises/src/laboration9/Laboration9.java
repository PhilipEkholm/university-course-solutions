...
public class Laboration9 {
    ...
    private void add( HashMap<String,String> map ) {
    	String 	key = JOptionPane.showInputDialog("Lägg till ett svenskt ord"),
    			value = JOptionPane.showInputDialog("Lägg nu till den engelska motsvarigheten");
    ...
    private void seek( HashMap<String,String> map ) {
    	String 	key = JOptionPane.showInputDialog("Sök, ange nyckel"),
    			value = "nyckel=" + key + ", värde=" + map.get(key);
    ...
    public void activity() {
        ...
        int choice = -1;
        try {
            HashMap<String,String> table = readFromFile( "files/lexikon.txt" );
            while( choice != 0 ) {
                do {
                    try {
                ...
                switch( choice ) {
                    ...
                    case 5 : writeToFile( "files/lexikon.txt", table );
                }
            }
        } catch ( IOException e ) {
    ...
    public static void main(String[] args) {
        Laboration9 lab9 = new Laboration9();
        lab9.activity();
    }
}
